...
class SideMenu extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    _dashboardController.changeActiveSideMenuButton(
      currentRoutePath: AutoRouter.of(context).currentSegments[1].path,
    );
    return Container(
      width: 250,
      decoration: BoxDecoration(
        ...
        child: Column(
          ...
          children: [
              ...
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, index) {
                  return SideMenuButton(
                    title: _dashboardController.sideMenuItemsList[index].title,
                    index: index,
                    iconPath:
                        _dashboardController.sideMenuItemsList[index].iconPath,
                  );
                },
              ),
            ),
            PrimaryButton(
              ...
              onTap: () {
                _dashboardController.onClickLogout(context: context);
              },
            )
          ],
        ),
